...
import { RedisCommand, RedisCommandArguments, RedisCommandRawReply, RedisModules, RedisPlugins, RedisScript, RedisScripts } from '@node-redis/client/dist/lib/commands';
import RedisMultiCommand, { RedisMultiQueuedCommand } from '@node-redis/client/dist/lib/multi-command';
