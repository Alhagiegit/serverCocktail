...
import COMMANDS from '@node-redis/client/dist/lib/cluster/commands';
import { RedisCommand, RedisCommandArguments, RedisCommandReply, RedisModules, RedisPlugins, RedisScript, RedisScripts } from '@node-redis/client/dist/lib/commands';
import { ClientCommandOptions, RedisClientCommandSignature, RedisClientOptions, WithModules, WithScripts } from '@node-redis/client/dist/lib/client';
import { ClusterNode } from '@node-redis/client/dist/lib/cluster/cluster-slots';
import { EventEmitter } from 'events';
import { RedisClusterMultiCommandType } from '@node-redis/client/dist/lib/cluster/multi-command';
