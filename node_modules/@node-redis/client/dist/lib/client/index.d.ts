...
import COMMANDS from '@node-redis/client/dist/lib/client/commands';
import { RedisCommand, RedisCommandArguments, RedisCommandRawReply, RedisCommandReply, RedisModules, RedisPlugins, RedisScript, RedisScripts } from '@node-redis/client/dist/lib/commands';
import { RedisSocketOptions } from '@node-redis/client/dist/lib/client/socket';
import { PubSubListener, QueueCommandOptions } from '@node-redis/client/dist/lib/client/commands-queue';
import { RedisClientMultiCommandType } from '@node-redis/client/dist/lib/client/multi-command';
import { RedisMultiQueuedCommand } from '@node-redis/client/dist/lib/multi-command';
import { EventEmitter } from 'events';
import { CommandOptions } from '@node-redis/client/dist/lib/command-options';
import { ScanOptions, ZMember } from '@node-redis/client/dist/lib/commands/generic-transformers';
import { ScanCommandOptions } from '@node-redis/client/dist/lib/commands/SCAN';
import { HScanTuple } from '@node-redis/client/dist/lib/commands/HSCAN';
import { LegacyCommandArguments } from '@node-redis/client/dist/lib/commander';
