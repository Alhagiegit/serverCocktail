    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(i < lett.length)) return [3 /*break*/, 5];
                return [4 /*yield*/, axios_1.default.get("http://thecocktaildb.com/api/json/v1/1/search.php?f=" + lett[i])];
            case 2:
                data = (_a.sent()).data;
                return [4 /*yield*/, data];
            case 3:
            ...
            case 4:
                i++;
                return [3 /*break*/, 1];
            case 5: return [2 /*return*/, drinksArray];
        }
    });
}); };
...
//get drink by id,drinkName, drinkCategory,isAlcoholic, ingredient 
/*router.get('/drink',({query:{idDrink}}, res)=>{
  let result:Drink;
  idDrink && (conn.query(filter('idDrink'),idDrink, (err, drink)=>{
    if(err) throw err;  result=drink; result? res.json(result):res.status(404).json({err:404, message: 'drink with this info is not found'}) }));
})*/
router.get('/drinks', function (_a, res) {
...
router.post('/drink', function (_a, res) {
    ...
    var drink = {
        ...
        strDrink: body.strDrink,
        strDrinkAlternate: body.strDrinkAlternate,
        strTags: body.strTags,
        strVideo: body.strVideo,
        strCategory: body.strCategory,
        strIBA: body.strIBA,
        strAlcoholic: body.strAlcoholic,
        strGlass: body.strGlass,
        strInstructions: body.strInstructions,
        strInstructionsES: body.strInstructionsES,
        strInstructionsDE: body.strInstructionsDE,
        strInstructionsFR: body.strInstructionsFR,
        strInstructionsIT: body.strInstructionsIT,
        strDrinkThumb: body.strDrinkThumb,
        strIngredient1: body.strIngredient1,
        strIngredient2: body.strIngredient2,
        strIngredient3: body.strIngredient3,
        strIngredient4: body.strIngredient4,
        strIngredient5: body.strIngredient5,
        strIngredient6: body.strIngredient6,
        strIngredient7: body.strIngredient7,
        strMeasure1: body.strMeasure1,
        strMeasure2: body.strMeasure2,
        strMeasure3: body.strMeasure3,
        strMeasure4: body.strMeasure4,
        strMeasure5: body.strMeasure5,
        strMeasure6: body.strMeasure6,
        strMeasure7: body.strMeasure7,
        strImageSource: body.strImageSource,
        strImageAttribution: body.strImageAttribution,
        strCreativeCommonsConfirmed: body.strCreativeCommonsConfirmed,
